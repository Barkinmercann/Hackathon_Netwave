...
def send_sms(name, location, date):
    ...
    account_sid = 'AC1d6ce6693e3e269b1e686b054fcb7a5d'
    # Your Auth Token from twilio.com/console
    auth_token = '902d329b7d74c2b8832f23f21f2b4c29'

    client = Client(account_sid, auth_token)

    message = client.messages.create(
        to="+905304119210",  # Replace with the recipient's phone number
        from_="+18156579500",  # Replace with your Twilio phone number
